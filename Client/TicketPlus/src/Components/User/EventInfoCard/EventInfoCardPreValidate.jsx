...
const EventInfoCardPreValidate = (props) => {
  return (
    <div className=" flex flex-col w-3/4 h-1/2 bg-white mx-auto my-10 text-justify p-5 font-montserrat font-medium rounded-xl">
      ...
      <ul>
        <li><p className="flex items-center text-lg gap-1">- General 0/400</p></li> 
        <li><p className="flex items-center text-lg gap-1">- Premium 0/200</p></li>
        <li><p className="flex items-center text-lg gap-1">- platinum 0/200</p></li>
        <li><p className="flex items-center text-lg gap-1">- VIP 0/100</p></li>
      </ul><br/>
    ...
    <div className="flex justify-end gap-2">
      ...
      <NavLink to="/BuyTicket"> <button className="flex flex-row items-center gap-2 bg-newblue hover:bg-darkblue rounded font-montserrat text-white font-normal py-2 px-4 "><ImTicket />Check in</button> </NavLink>            
        </div>
    </div>
  );
};
