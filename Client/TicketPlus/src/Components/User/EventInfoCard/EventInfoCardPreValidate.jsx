...
const EventInfoCardPreValidate = (props) => {
  return (
    ...
    <div className="flex justify-end gap-2">
            <button className=" flex flex-row items-center gap-2 bg-unsuccesful hover:bg-darkunsuccesful rounded font-montserrat text-white font-normal py-1 px-3 "><ImCross/>Deny</button>
            <NavLink to="/BuyTicket"> <button className="flex flex-row items-center gap-2 bg-newblue hover:bg-darkblue rounded font-montserrat text-white font-normal py-1 px-3 "><ImTicket />Buy Tickets</button> </NavLink>
